        ...
        <div className="min-h-screen bg-white flex flex-col items-center py-10 px-4">
            ...
            <div className="w-full max-w-xl">
                ...
                <div className="text-center mt-8">
                    <button className="text-[#007C92] underline font-semibold text-sm">
                        MANAGE BOOKING
                    </button>
                </div>
            </div>
                ...
                <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
                    <div className="bg-white w-full max-w-md rounded-3xl shadow-lg p-6 relative animate-fadeIn">
                        ...
                        <div className="relative pl-12">
                            ...
                            {/* VERTICAL LINE */}
                            <div className="absolute top-2 left-5 w-[2px] h-[88%] bg-gray-200"></div>
...
//             {/* TOP LOGO (Just a placeholder V shape) */}
//             <div className="flex justify-center mb-4 w-30 h-10">
//                 <img src={logo} alt="" />
//             </div>
...
//             {/* CONFIRMATION CARD */}
//             <div className="w-full max-w-xl bg-white shadow-md rounded-xl p-5 mb-6 flex items-center justify-between cursor-pointer">
...
//                         Cancellation charges apply for cancellations within 6 hours of the service start time
//                         (
//                         <a href="#" className="text-[#007C92] underline">
//                             Cancellation policy
//                         </a>
//                         ).
//                     </li>
