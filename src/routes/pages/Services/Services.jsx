...
const Services = () => {
    const { services, button, setActiveId, activeId, content, itemSummary, total, vat, serviceCharge, showInput, setShowInput, serviceTitle
    } = useSummary();
                ...
                <div className="md:w-[60%] md:mb-4 md:space-y-4">
                    ...
                    <div className="relative p-4 md:p-0">
                        ...
                        {suggestions.length > 0 && (
                            <div className="absolute top-full left-0 w-full bg-white border border-gray-300 shadow-md rounded-md mt-1 z-50 max-h-80 overflow-y-auto">
                                {suggestions.length > 0 ? (
