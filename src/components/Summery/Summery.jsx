...
export default function Summery({ total, showInput, setShowInput, vat, itemSummary, serviceCharge, address, date, time, serviceTitle, liveAddress }) {
    const [promo, setPromo] = useState("");
    const [open, setOpen] = useState(false);
    const { removeItem } = useItem();

    // console.log("Live Address:", liveAddress);
    ...
    // Address display করার ফাংশন
    const renderAddress = () => {
        // প্রথমে liveAddress চেক করুন, তারপর saved address
        ...
        // শুধু available ফিল্ডগুলো দেখাবে
        const addressParts = [];
