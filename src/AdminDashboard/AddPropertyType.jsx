...
// const AddPropertyType = () => {
//     const [content] = useCoverContent();
//     // const serviceType = content[0]?.propertyType?.[0] || [];


//     console.log(content.map(c => c.title));
//     const { register, handleSubmit, formState: { errors }, reset } = useForm();
//     const [loading, setLoading] = useState(false);
...
//                     >
//                         <option value="">Select Service Type</option>
//                         <option value={content.map(c => c.id)}>
//                             {content.map((c, i) => c.title[i])}
//                         </option>
//                     </select>
//                     {errors.serviceTypeId && (
//                         <p className="text-red-500 text-sm">Service Type is required</p>
