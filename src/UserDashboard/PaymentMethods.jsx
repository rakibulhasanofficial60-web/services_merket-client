        ...
        <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-4">
          ...
          <div>
            <input
              type="text"
              placeholder="Enter your credit card number"
              className="w-full border border-red-300 rounded-md px-4 py-2 focus:ring-0 outline-none"
              {...register("cardNumber", { required: true })}
            />
            {errors.cardNumber && (
          ...
          <button
            type="submit"
            className="w-fit mx-auto bg-[#F26A2E] text-white font-medium px-8 py-2 rounded-md mt-4 hover:bg-[#e05d22] transition"
          >
            ADD CARD
          </button>
